function [phi, u, w] = FentonU(k0, h, a, modeNo, theta, z)
   ...
   g = 9.81;
    ...
    phi = omega0/k0 *a * A11Fen*cosh(k0*(z+h))*sin(theta) + ...
        omega0*a^2 * A22Fen*cosh(2*k0*(z+h))*sin(2*theta) + ...
        omega0*k0 *a^3 * A31Fen*cosh(k0*(z+h))*sin(theta) + ...
        omega0*k0 *a^3 * A33Fen*cosh(3*k0*(z+h))*sin(3*theta) + ...
        omega0*k0^2 *a^4 * A42Fen*cosh(2*k0*(z+h))*sin(2*theta) + ...
        omega0*k0^2 *a^4 * A44Fen*cosh(4*k0*(z+h))*sin(4*theta) + ...
        omega0*k0^3 *a^5 * A51Fen*cosh(k0*(z+h))*sin(theta) + ...
        omega0*k0^3 *a^5 * A53Fen*cosh(3*k0*(z+h))*sin(3*theta) + ...
        omega0*k0^3 *a^5 * A55Fen*cosh(5*k0*(z+h))*sin(5*theta);
    u = omega0*a * A11Fen*cosh(k0*(z+h))*cos(theta) + ...
        omega0*a^2 * A22Fen*cosh(2*k0*(z+h))*cos(2*theta)*2*k0 + ...
        omega0*k0 *a^3 * A31Fen*cosh(k0*(z+h))*cos(theta)*k0 + ...
        omega0*k0 *a^3 * A33Fen*cosh(3*k0*(z+h))*cos(3*theta)*3*k0 + ...
        omega0*k0^2 *a^4 * A42Fen*cosh(2*k0*(z+h))*cos(2*theta)*2*k0 + ...
        omega0*k0^2 *a^4 * A44Fen*cosh(4*k0*(z+h))*cos(4*theta)*4*k0 + ...
        omega0*k0^3 *a^5 * A51Fen*cosh(k0*(z+h))*cos(theta)*k0 + ...
        omega0*k0^3 *a^5 * A53Fen*cosh(3*k0*(z+h))*cos(3*theta)*3*k0 + ...
        omega0*k0^3 *a^5 * A55Fen*cosh(5*k0*(z+h))*cos(5*theta)*5*k0;
    w = omega0*a * A11Fen*sinh(k0*(z+h))*sin(theta) + ...
        omega0*a^2*A22Fen*sinh(2*k0*(z+h))*sin(2*theta)*2*k0 + ...
        omega0*k0*a^3*A31Fen*sinh(k0*(z+h))*sin(theta)*k0 + ...
        omega0*k0*a^3*A33Fen*sinh(3*k0*(z+h))*sin(3*theta)*3*k0 + ...
        omega0*k0^2*a^4* A42Fen*sinh(2*k0*(z+h))*sin(2*theta)*2*k0 + ...
        omega0*k0^2*a^4* A44Fen*sinh(4*k0*(z+h))*sin(4*theta)*4*k0 + ...
        omega0*k0^3*a^5 * A51Fen*sinh(k0*(z+h))*sin(theta)*k0 + ...
        omega0*k0^3*a^5 * A53Fen*sinh(3*k0*(z+h))*sin(3*theta)*3*k0 + ...
        omega0*k0^3*a^5 * A55Fen*sinh(5*k0*(z+h))*sin(5*theta)*5*k0;
    phi = phi'; u = u'; w = w';
